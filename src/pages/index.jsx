  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="I’m Xinyi, an arts ethusiast now driving into the world of technology."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Xinyi, an arts enthusiast now driving into the world of technology. I harness technology for impactful solutions in arts, culture, and media.
          </p>
          <div className="mt-6 flex gap-6">
            ...
            {/*/>*/}
            <SocialLink
              href="https://github.com/xinyichen03"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://linkedin.com/in/xinyi-c03"
  ...
  return {
    props: {
      articles: (await getAllArticles())
        .filter(articles => !articles.draft)
        .slice(0, 4)
